...
public class ModificarEmpleadoGUI extends JFrame{
	...
	public ModificarEmpleadoGUI() {
		setTitle("MODIFICAR EMPLEADO");
		this.mainPanel = new JPanel();
		mainPanel.setLayout(new BoxLayout(mainPanel,BoxLayout.Y_AXIS));
		mainPanel.setBorder(BorderFactory.createTitledBorder("MODIFICAR EMPLEADO"));
		...
		accept.addActionListener(new ActionListener(){
			 ...
			 public void actionPerformed(ActionEvent arg0) {
				 if(fnombre.getText().equals("")||fDNI.getText().equals("")||fapellidos.getText().equals("")||fpassword.getText().equals("")||ftelefono.getText().equals("")) {
					 ...
					 ControladorImp.getInstance().accion(Evento.MODIFICAR_EMPLEADO, emp);
				 }
			 };
		});
