...
public class FactoriaVistasImp extends FactoriaVistas {
	@Override
	public AltaClienteGUI generaAltaClienteGUI(int opcion) {
		return new AltaClienteGUI(opcion);
	}
	...
	@Override
	public ModificarClienteGUI generaModificarClienteGUI(int opcion) {
		return new ModificarClienteGUI(opcion);
	}
