...
public class BajaClienteGUI extends JFrame{
	...
	public BajaClienteGUI() {
		setTitle("BAJA CLIENTE");
		this.mainPanel = new JPanel();
		mainPanel.setLayout(new BoxLayout(mainPanel,BoxLayout.Y_AXIS));
		mainPanel.setBorder(BorderFactory.createTitledBorder("BAJA CLIENTE"));
		...
		accept.addActionListener(new ActionListener(){
			 ...
			 public void actionPerformed(ActionEvent arg0) {
				 if(fdni.getText().equals("")) {
					 ...
					 setVisible(false);
					 ControladorImp.getInstance().accion(Evento.BAJA_CLIENTE, dni);
				 }
			 };
		});
